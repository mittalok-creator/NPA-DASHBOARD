const CACHE_NAME = 'upgb-ots-shell-v108';
...
const SHELL_ASSETS = [
  ...
  './js/app.js?v=20260815c',
  './js/auth.js?v=20260815c',
  './js/publish.js?v=20260815c',
  './js/splash.js?v=20260815c',
  './js/vendor/xlsx.full.min.js?v=20260815c',
  './js/vendor/exceljs.min.js?v=20260815c',
  './js/vendor/pdf.min.js?v=20260815c',
