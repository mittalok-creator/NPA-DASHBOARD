const CACHE_NAME = 'upgb-ots-shell-v196';
...
const SHELL_ASSETS = [
  './',
  './index.html',
  './css/styles.css?v=20260909t',
  './js/app.js?v=20260909t',
  './js/auth.js?v=20260909t',
  './js/publish.js?v=20260909t',
  './js/splash.js?v=20260909t',
  './js/vendor/xlsx.full.min.js?v=20260909t',
  './js/vendor/exceljs.min.js?v=20260909t',
