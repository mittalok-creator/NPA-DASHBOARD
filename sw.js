const CACHE_NAME = 'upgb-ots-shell-v160';
...
const SHELL_ASSETS = [
  './',
  './index.html',
  './css/styles.css?v=20260905c',
  './js/app.js?v=20260905c',
  './js/auth.js?v=20260905c',
  './js/publish.js?v=20260905c',
  './js/splash.js?v=20260905c',
  './js/vendor/xlsx.full.min.js?v=20260905c',
  './js/vendor/exceljs.min.js?v=20260905c',
