const CACHE_NAME = 'upgb-ots-shell-v14';
const SHELL_ASSETS = [
  './',
  './index.html',
  './css/styles.css?v=20260722k',
  './js/app.js?v=20260722k',
  './js/auth.js?v=20260722k',
  './js/publish.js?v=20260722k',
  './js/splash.js?v=20260722k',
  './js/vendor/xlsx.full.min.js?v=20260722k',
