const CACHE_NAME = 'upgb-ots-shell-v8';
const SHELL_ASSETS = [
  './',
  './index.html',
  './css/styles.css?v=20260722e',
  './js/app.js?v=20260722e',
  './js/auth.js?v=20260722e',
  './js/publish.js?v=20260722e',
  './js/splash.js?v=20260722e',
  './js/vendor/xlsx.full.min.js?v=20260722e',
