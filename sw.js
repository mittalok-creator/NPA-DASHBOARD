const CACHE_NAME = 'upgb-ots-shell-v186';
...
const SHELL_ASSETS = [
  './',
  './index.html',
  './css/styles.css?v=20260909j',
  './js/app.js?v=20260909j',
  './js/auth.js?v=20260909j',
  './js/publish.js?v=20260909j',
  './js/splash.js?v=20260909j',
  './js/vendor/xlsx.full.min.js?v=20260909j',
  './js/vendor/exceljs.min.js?v=20260909j',
