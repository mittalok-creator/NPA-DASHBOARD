const CACHE_NAME = 'upgb-ots-shell-v209';
...
const SHELL_ASSETS = [
  './',
  './index.html',
  './css/styles.css?v=20260911a',
  './js/app.js?v=20260911a',
  './js/auth.js?v=20260911a',
  './js/publish.js?v=20260911a',
  './js/splash.js?v=20260911a',
  './js/vendor/xlsx.full.min.js?v=20260911a',
  './js/vendor/exceljs.min.js?v=20260911a',
