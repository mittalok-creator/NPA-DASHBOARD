const CACHE_NAME = 'upgb-ots-shell-v7';
const SHELL_ASSETS = [
  './',
  './index.html',
  './css/styles.css?v=20260722d',
  './js/app.js?v=20260722d',
  './js/auth.js?v=20260722d',
  './js/publish.js?v=20260722d',
  './js/splash.js?v=20260722d',
  './js/vendor/xlsx.full.min.js?v=20260722d',
