const CACHE_NAME = 'upgb-ots-shell-v106';
...
const SHELL_ASSETS = [
  './',
  './index.html',
  './css/styles.css?v=20260815a',
  './js/app.js?v=20260815a',
  './js/auth.js?v=20260815a',
  './js/publish.js?v=20260815a',
  './js/splash.js?v=20260815a',
  './js/vendor/xlsx.full.min.js?v=20260815a',
  './js/vendor/exceljs.min.js?v=20260815a',
  './js/vendor/pdf.min.js?v=20260815a',
