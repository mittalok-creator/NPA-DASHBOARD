const CACHE_NAME = 'upgb-ots-shell-v205';
...
const SHELL_ASSETS = [
  ...
  './js/app.js?v=20260910f',
  './js/auth.js?v=20260910f',
  './js/publish.js?v=20260910f',
  './js/splash.js?v=20260910f',
  './js/vendor/xlsx.full.min.js?v=20260910f',
  './js/vendor/exceljs.min.js?v=20260910f',
