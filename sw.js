const CACHE_NAME = 'upgb-ots-shell-v19';
const SHELL_ASSETS = [
  './',
  './index.html',
  './css/styles.css?v=20260722p',
  './js/app.js?v=20260722p',
  './js/auth.js?v=20260722p',
  './js/publish.js?v=20260722p',
  './js/splash.js?v=20260722p',
  './js/vendor/xlsx.full.min.js?v=20260722p',
