const CACHE_NAME = 'upgb-ots-shell-v159';
...
const SHELL_ASSETS = [
  './',
  './index.html',
  './css/styles.css?v=20260905b',
  './js/app.js?v=20260905b',
  './js/auth.js?v=20260905b',
  './js/publish.js?v=20260905b',
  './js/splash.js?v=20260905b',
  './js/vendor/xlsx.full.min.js?v=20260905b',
  './js/vendor/exceljs.min.js?v=20260905b',
