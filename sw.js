const CACHE_NAME = 'upgb-ots-shell-v187';
...
const SHELL_ASSETS = [
  './',
  './index.html',
  './css/styles.css?v=20260909k',
  './js/app.js?v=20260909k',
  './js/auth.js?v=20260909k',
  './js/publish.js?v=20260909k',
  './js/splash.js?v=20260909k',
  './js/vendor/xlsx.full.min.js?v=20260909k',
  './js/vendor/exceljs.min.js?v=20260909k',
