const CACHE_NAME = 'upgb-ots-shell-v114';
...
const SHELL_ASSETS = [
  './',
  './index.html',
  './css/styles.css?v=20260815i',
  './js/app.js?v=20260815i',
  './js/auth.js?v=20260815i',
  './js/publish.js?v=20260815i',
  './js/splash.js?v=20260815i',
  './js/vendor/xlsx.full.min.js?v=20260815i',
  './js/vendor/exceljs.min.js?v=20260815i',
  './js/vendor/pdf.min.js?v=20260815i',
