const CACHE_NAME = 'upgb-ots-shell-v130';
...
const SHELL_ASSETS = [
  './',
  './index.html',
  './css/styles.css?v=20260818b',
  './js/app.js?v=20260818b',
  './js/auth.js?v=20260818b',
  './js/publish.js?v=20260818b',
  './js/splash.js?v=20260818b',
  './js/vendor/xlsx.full.min.js?v=20260818b',
  './js/vendor/exceljs.min.js?v=20260818b',
  './js/vendor/pdf.min.js?v=20260818b',
