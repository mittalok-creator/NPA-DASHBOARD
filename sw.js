const CACHE_NAME = 'upgb-ots-shell-v20';
const SHELL_ASSETS = [
  './',
  './index.html',
  './css/styles.css?v=20260723a',
  './js/app.js?v=20260723a',
  './js/auth.js?v=20260723a',
  './js/publish.js?v=20260723a',
  './js/splash.js?v=20260723a',
  './js/vendor/xlsx.full.min.js?v=20260723a',
