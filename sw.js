const CACHE_NAME = 'upgb-ots-shell-v203';
...
const SHELL_ASSETS = [
  ...
  './js/app.js?v=20260910d',
  './js/auth.js?v=20260910d',
  './js/publish.js?v=20260910d',
  './js/splash.js?v=20260910d',
  './js/vendor/xlsx.full.min.js?v=20260910d',
  './js/vendor/exceljs.min.js?v=20260910d',
