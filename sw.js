const CACHE_NAME = 'upgb-ots-shell-v122';
...
const SHELL_ASSETS = [
  ...
  './js/app.js?v=20260815q',
  './js/auth.js?v=20260815q',
  './js/publish.js?v=20260815q',
  './js/splash.js?v=20260815q',
  './js/vendor/xlsx.full.min.js?v=20260815q',
  './js/vendor/exceljs.min.js?v=20260815q',
  './js/vendor/pdf.min.js?v=20260815q',
