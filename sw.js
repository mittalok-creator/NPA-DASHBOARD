const CACHE_NAME = 'upgb-ots-shell-v156';
...
const SHELL_ASSETS = [
  './',
  './index.html',
  './css/styles.css?v=20260903a',
  './js/app.js?v=20260903a',
  './js/auth.js?v=20260903a',
  './js/publish.js?v=20260903a',
  './js/splash.js?v=20260903a',
  './js/vendor/xlsx.full.min.js?v=20260903a',
  './js/vendor/exceljs.min.js?v=20260903a',
