const CACHE_NAME = 'upgb-ots-shell-v129';
...
const SHELL_ASSETS = [
  './',
  './index.html',
  './css/styles.css?v=20260818a',
  './js/app.js?v=20260818a',
  './js/auth.js?v=20260818a',
  './js/publish.js?v=20260818a',
  './js/splash.js?v=20260818a',
  './js/vendor/xlsx.full.min.js?v=20260818a',
  './js/vendor/exceljs.min.js?v=20260818a',
  './js/vendor/pdf.min.js?v=20260818a',
