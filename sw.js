const CACHE_NAME = 'upgb-ots-shell-v199';
...
const SHELL_ASSETS = [
  './',
  './index.html',
  './css/styles.css?v=20260909w',
  './js/app.js?v=20260909w',
  './js/auth.js?v=20260909w',
  './js/publish.js?v=20260909w',
  './js/splash.js?v=20260909w',
  './js/vendor/xlsx.full.min.js?v=20260909w',
  './js/vendor/exceljs.min.js?v=20260909w',
