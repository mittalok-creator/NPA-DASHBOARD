const CACHE_NAME = 'upgb-ots-shell-v194';
...
const SHELL_ASSETS = [
  './',
  './index.html',
  './css/styles.css?v=20260909r',
  './js/app.js?v=20260909r',
  './js/auth.js?v=20260909r',
  './js/publish.js?v=20260909r',
  './js/splash.js?v=20260909r',
  './js/vendor/xlsx.full.min.js?v=20260909r',
  './js/vendor/exceljs.min.js?v=20260909r',
