const CACHE_NAME = 'upgb-ots-shell-v153';
...
const SHELL_ASSETS = [
  ...
  './js/auth.js?v=20260901g',
  './js/publish.js?v=20260901g',
  './js/splash.js?v=20260901g',
  './js/vendor/xlsx.full.min.js?v=20260901g',
  './js/vendor/exceljs.min.js?v=20260901g',
