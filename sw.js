const CACHE_NAME = 'upgb-ots-shell-v131';
...
const SHELL_ASSETS = [
  './',
  './index.html',
  './css/styles.css?v=20260818c',
  './js/app.js?v=20260818c',
  './js/auth.js?v=20260818c',
  './js/publish.js?v=20260818c',
  './js/splash.js?v=20260818c',
  './js/vendor/xlsx.full.min.js?v=20260818c',
  './js/vendor/exceljs.min.js?v=20260818c',
  './js/vendor/pdf.min.js?v=20260818c',
