const CACHE_NAME = 'upgb-ots-shell-v202';
...
const SHELL_ASSETS = [
  './',
  './index.html',
  './css/styles.css?v=20260910c',
  './js/app.js?v=20260910c',
  './js/auth.js?v=20260910c',
  './js/publish.js?v=20260910c',
  './js/splash.js?v=20260910c',
  './js/vendor/xlsx.full.min.js?v=20260910c',
  './js/vendor/exceljs.min.js?v=20260910c',
