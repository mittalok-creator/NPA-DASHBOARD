const CACHE_NAME = 'upgb-ots-shell-v109';
...
const SHELL_ASSETS = [
  './',
  './index.html',
  './css/styles.css?v=20260815d',
  './js/app.js?v=20260815d',
  './js/auth.js?v=20260815d',
  './js/publish.js?v=20260815d',
  './js/splash.js?v=20260815d',
  './js/vendor/xlsx.full.min.js?v=20260815d',
  './js/vendor/exceljs.min.js?v=20260815d',
  './js/vendor/pdf.min.js?v=20260815d',
