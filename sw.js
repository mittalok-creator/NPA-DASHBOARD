const CACHE_NAME = 'upgb-ots-shell-v116';
...
const SHELL_ASSETS = [
  ...
  './js/app.js?v=20260815k',
  './js/auth.js?v=20260815k',
  './js/publish.js?v=20260815k',
  './js/splash.js?v=20260815k',
  './js/vendor/xlsx.full.min.js?v=20260815k',
  './js/vendor/exceljs.min.js?v=20260815k',
  './js/vendor/pdf.min.js?v=20260815k',
