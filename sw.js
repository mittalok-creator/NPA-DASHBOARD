const CACHE_NAME = 'upgb-ots-shell-v148';
...
const SHELL_ASSETS = [
  './',
  './index.html',
  './css/styles.css?v=20260901b',
  './js/app.js?v=20260901b',
  './js/auth.js?v=20260901b',
  './js/publish.js?v=20260901b',
  './js/splash.js?v=20260901b',
  './js/vendor/xlsx.full.min.js?v=20260901b',
  './js/vendor/exceljs.min.js?v=20260901b',
