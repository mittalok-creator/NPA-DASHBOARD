const CACHE_NAME = 'upgb-ots-shell-v118';
...
const SHELL_ASSETS = [
  './',
  './index.html',
  './css/styles.css?v=20260815m',
  './js/app.js?v=20260815m',
  './js/auth.js?v=20260815m',
  './js/publish.js?v=20260815m',
  './js/splash.js?v=20260815m',
  './js/vendor/xlsx.full.min.js?v=20260815m',
  './js/vendor/exceljs.min.js?v=20260815m',
  './js/vendor/pdf.min.js?v=20260815m',
