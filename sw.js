const CACHE_NAME = 'upgb-ots-shell-v147';
...
const SHELL_ASSETS = [
  './',
  './index.html',
  './css/styles.css?v=20260901a',
  './js/app.js?v=20260901a',
  './js/auth.js?v=20260901a',
  './js/publish.js?v=20260901a',
  './js/splash.js?v=20260901a',
  './js/vendor/xlsx.full.min.js?v=20260901a',
  './js/vendor/exceljs.min.js?v=20260901a',
