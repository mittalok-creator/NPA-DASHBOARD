const CACHE_NAME = 'upgb-ots-shell-v206';
...
const SHELL_ASSETS = [
  ...
  './js/auth.js?v=20260910g',
  './js/publish.js?v=20260910g',
  './js/splash.js?v=20260910g',
  './js/vendor/xlsx.full.min.js?v=20260910g',
  './js/vendor/exceljs.min.js?v=20260910g',
