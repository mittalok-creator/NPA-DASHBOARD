const CACHE_NAME = 'upgb-ots-shell-v93';
...
const SHELL_ASSETS = [
  './',
  './index.html',
  './css/styles.css?v=20260814o',
  './js/app.js?v=20260814o',
  './js/auth.js?v=20260814o',
  './js/publish.js?v=20260814o',
  './js/splash.js?v=20260814o',
  './js/vendor/xlsx.full.min.js?v=20260814o',
  './js/vendor/exceljs.min.js?v=20260814o',
  './js/vendor/pdf.min.js?v=20260814o',
