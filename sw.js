const CACHE_NAME = 'upgb-ots-shell-v173';
...
const SHELL_ASSETS = [
  './',
  './index.html',
  './css/styles.css?v=20260908e',
  './js/app.js?v=20260908e',
  './js/auth.js?v=20260908e',
  './js/publish.js?v=20260908e',
  './js/splash.js?v=20260908e',
  './js/vendor/xlsx.full.min.js?v=20260908e',
  './js/vendor/exceljs.min.js?v=20260908e',
