const CACHE_NAME = 'upgb-ots-shell-v179';
...
const SHELL_ASSETS = [
  './',
  './index.html',
  './css/styles.css?v=20260909c',
  './js/app.js?v=20260909c',
  './js/auth.js?v=20260909c',
  './js/publish.js?v=20260909c',
  './js/splash.js?v=20260909c',
  './js/vendor/xlsx.full.min.js?v=20260909c',
  './js/vendor/exceljs.min.js?v=20260909c',
