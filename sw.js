const CACHE_NAME = 'upgb-ots-shell-v144';
...
const SHELL_ASSETS = [
  './',
  './index.html',
  './css/styles.css?v=20260829d',
  './js/app.js?v=20260829d',
  './js/auth.js?v=20260829d',
  './js/publish.js?v=20260829d',
  './js/splash.js?v=20260829d',
  './js/vendor/xlsx.full.min.js?v=20260829d',
  './js/vendor/exceljs.min.js?v=20260829d',
