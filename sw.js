const CACHE_NAME = 'upgb-ots-shell-v107';
...
const SHELL_ASSETS = [
  ...
  './js/app.js?v=20260815b',
  './js/auth.js?v=20260815b',
  './js/publish.js?v=20260815b',
  './js/splash.js?v=20260815b',
  './js/vendor/xlsx.full.min.js?v=20260815b',
  './js/vendor/exceljs.min.js?v=20260815b',
  './js/vendor/pdf.min.js?v=20260815b',
