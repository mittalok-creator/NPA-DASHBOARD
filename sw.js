const CACHE_NAME = 'upgb-ots-shell-v18';
const SHELL_ASSETS = [
  './',
  './index.html',
  './css/styles.css?v=20260722o',
  './js/app.js?v=20260722o',
  './js/auth.js?v=20260722o',
  './js/publish.js?v=20260722o',
  './js/splash.js?v=20260722o',
  './js/vendor/xlsx.full.min.js?v=20260722o',
