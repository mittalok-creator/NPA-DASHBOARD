const CACHE_NAME = 'upgb-ots-shell-v190';
...
const SHELL_ASSETS = [
  './',
  './index.html',
  './css/styles.css?v=20260909n',
  './js/app.js?v=20260909n',
  './js/auth.js?v=20260909n',
  './js/publish.js?v=20260909n',
  './js/splash.js?v=20260909n',
  './js/vendor/xlsx.full.min.js?v=20260909n',
  './js/vendor/exceljs.min.js?v=20260909n',
