const CACHE_NAME = 'upgb-ots-shell-v176';
...
const SHELL_ASSETS = [
  './',
  './index.html',
  './css/styles.css?v=20260908h',
  './js/app.js?v=20260908h',
  './js/auth.js?v=20260908h',
  './js/publish.js?v=20260908h',
  './js/splash.js?v=20260908h',
  './js/vendor/xlsx.full.min.js?v=20260908h',
  './js/vendor/exceljs.min.js?v=20260908h',
