const CACHE_NAME = 'upgb-ots-shell-v157';
...
const SHELL_ASSETS = [
  './',
  './index.html',
  './css/styles.css?v=20260903b',
  './js/app.js?v=20260903b',
  './js/auth.js?v=20260903b',
  './js/publish.js?v=20260903b',
  './js/splash.js?v=20260903b',
  './js/vendor/xlsx.full.min.js?v=20260903b',
  './js/vendor/exceljs.min.js?v=20260903b',
