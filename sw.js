const CACHE_NAME = 'upgb-ots-shell-v177';
...
const SHELL_ASSETS = [
  ...
  './js/app.js?v=20260909a',
  './js/auth.js?v=20260909a',
  './js/publish.js?v=20260909a',
  './js/splash.js?v=20260909a',
  './js/vendor/xlsx.full.min.js?v=20260909a',
  './js/vendor/exceljs.min.js?v=20260909a',
