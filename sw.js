const CACHE_NAME = 'upgb-ots-shell-v208';
...
const SHELL_ASSETS = [
  './',
  './index.html',
  './css/styles.css?v=20260910i',
  './js/app.js?v=20260910i',
  './js/auth.js?v=20260910i',
  './js/publish.js?v=20260910i',
  './js/splash.js?v=20260910i',
  './js/vendor/xlsx.full.min.js?v=20260910i',
  './js/vendor/exceljs.min.js?v=20260910i',
