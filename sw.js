const CACHE_NAME = 'upgb-ots-shell-v121';
...
const SHELL_ASSETS = [
  ...
  './js/app.js?v=20260815p',
  './js/auth.js?v=20260815p',
  './js/publish.js?v=20260815p',
  './js/splash.js?v=20260815p',
  './js/vendor/xlsx.full.min.js?v=20260815p',
  './js/vendor/exceljs.min.js?v=20260815p',
  './js/vendor/pdf.min.js?v=20260815p',
