const CACHE_NAME = 'upgb-ots-shell-v167';
...
const SHELL_ASSETS = [
  './',
  './index.html',
  './css/styles.css?v=20260907g',
  './js/app.js?v=20260907g',
  './js/auth.js?v=20260907g',
  './js/publish.js?v=20260907g',
  './js/splash.js?v=20260907g',
  './js/vendor/xlsx.full.min.js?v=20260907g',
  './js/vendor/exceljs.min.js?v=20260907g',
