const CACHE_NAME = 'upgb-ots-shell-v98';
...
const SHELL_ASSETS = [
  './',
  './index.html',
  './css/styles.css?v=20260814t',
  './js/app.js?v=20260814t',
  './js/auth.js?v=20260814t',
  './js/publish.js?v=20260814t',
  './js/splash.js?v=20260814t',
  './js/vendor/xlsx.full.min.js?v=20260814t',
  './js/vendor/exceljs.min.js?v=20260814t',
  './js/vendor/pdf.min.js?v=20260814t',
