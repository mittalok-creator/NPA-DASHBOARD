const CACHE_NAME = 'upgb-ots-shell-v172';
...
const SHELL_ASSETS = [
  './',
  './index.html',
  './css/styles.css?v=20260908d',
  './js/app.js?v=20260908d',
  './js/auth.js?v=20260908d',
  './js/publish.js?v=20260908d',
  './js/splash.js?v=20260908d',
  './js/vendor/xlsx.full.min.js?v=20260908d',
  './js/vendor/exceljs.min.js?v=20260908d',
