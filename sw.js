const CACHE_NAME = 'upgb-ots-shell-v178';
...
const SHELL_ASSETS = [
  './',
  './index.html',
  './css/styles.css?v=20260909b',
  './js/app.js?v=20260909b',
  './js/auth.js?v=20260909b',
  './js/publish.js?v=20260909b',
  './js/splash.js?v=20260909b',
  './js/vendor/xlsx.full.min.js?v=20260909b',
  './js/vendor/exceljs.min.js?v=20260909b',
