const CACHE_NAME = 'upgb-ots-shell-v4';
const SHELL_ASSETS = [
  './',
  './index.html',
  './css/styles.css?v=20260722a',
  './js/app.js?v=20260722a',
  './js/auth.js?v=20260722a',
  './js/splash.js?v=20260722a',
  './js/vendor/xlsx.full.min.js?v=20260722a',
