const CACHE_NAME = 'upgb-ots-shell-v115';
...
const SHELL_ASSETS = [
  './',
  './index.html',
  './css/styles.css?v=20260815j',
  './js/app.js?v=20260815j',
  './js/auth.js?v=20260815j',
  './js/publish.js?v=20260815j',
  './js/splash.js?v=20260815j',
  './js/vendor/xlsx.full.min.js?v=20260815j',
  './js/vendor/exceljs.min.js?v=20260815j',
  './js/vendor/pdf.min.js?v=20260815j',
