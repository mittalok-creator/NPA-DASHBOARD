const CACHE_NAME = 'upgb-ots-shell-v94';
...
const SHELL_ASSETS = [
  './',
  './index.html',
  './css/styles.css?v=20260814p',
  './js/app.js?v=20260814p',
  './js/auth.js?v=20260814p',
  './js/publish.js?v=20260814p',
  './js/splash.js?v=20260814p',
  './js/vendor/xlsx.full.min.js?v=20260814p',
  './js/vendor/exceljs.min.js?v=20260814p',
  './js/vendor/pdf.min.js?v=20260814p',
