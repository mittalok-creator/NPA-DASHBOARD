const CACHE_NAME = 'upgb-ots-shell-v204';
...
const SHELL_ASSETS = [
  './',
  './index.html',
  './css/styles.css?v=20260910e',
  './js/app.js?v=20260910e',
  './js/auth.js?v=20260910e',
  './js/publish.js?v=20260910e',
  './js/splash.js?v=20260910e',
  './js/vendor/xlsx.full.min.js?v=20260910e',
  './js/vendor/exceljs.min.js?v=20260910e',
