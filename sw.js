const CACHE_NAME = 'upgb-ots-shell-v158';
...
const SHELL_ASSETS = [
  './',
  './index.html',
  './css/styles.css?v=20260905a',
  './js/app.js?v=20260905a',
  './js/auth.js?v=20260905a',
  './js/publish.js?v=20260905a',
  './js/splash.js?v=20260905a',
  './js/vendor/xlsx.full.min.js?v=20260905a',
  './js/vendor/exceljs.min.js?v=20260905a',
