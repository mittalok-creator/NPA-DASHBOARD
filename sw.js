const CACHE_NAME = 'upgb-ots-shell-v9';
const SHELL_ASSETS = [
  './',
  './index.html',
  './css/styles.css?v=20260722f',
  './js/app.js?v=20260722f',
  './js/auth.js?v=20260722f',
  './js/publish.js?v=20260722f',
  './js/splash.js?v=20260722f',
  './js/vendor/xlsx.full.min.js?v=20260722f',
