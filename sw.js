const CACHE_NAME = 'upgb-ots-shell-v198';
...
const SHELL_ASSETS = [
  './',
  './index.html',
  './css/styles.css?v=20260909v',
  './js/app.js?v=20260909v',
  './js/auth.js?v=20260909v',
  './js/publish.js?v=20260909v',
  './js/splash.js?v=20260909v',
  './js/vendor/xlsx.full.min.js?v=20260909v',
  './js/vendor/exceljs.min.js?v=20260909v',
