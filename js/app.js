...
// active at all.
const UTILITY_CHILD_VIEWS = ['onedrive','passsheet','regionsummary','pnpasummary','telephonedirectory','hbrreport','npasolsummary','branchmap','branchsplit','kccoverduesummary'];
...
const TOOL_IFRAME_BY_VIEW = {
  ...
  kccoverduesummary: 'kccOverdueSummaryFrame',
};
